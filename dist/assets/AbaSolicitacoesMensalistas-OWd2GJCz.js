...
import { c as createLucideIcon, X, A as ArrowLeft, U as User, C as Car, f as AlertTriangle, D as DollarSign, H as History, s as supabaseService, d as audioService, R as RefreshCw, g as Clock$1, b as CheckCircle } from './App-DLthjJE9.js';
...
function PaginaDetalhesMensalista({ mensalistaId, onVoltar, onAtualizar }) {
  ...
  if (!mensalista) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: onVoltar, className: "px-6 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-xl transition-all", children: "Voltar" })
    ] });
  }
...
//# sourceMappingURL=AbaSolicitacoesMensalistas-OWd2GJCz.js.map
